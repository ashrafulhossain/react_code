    ...
    return (
        <div className='mt-32 mb-10 w-full md:w-1/2 mx-auto custom-shadow bg-[#e8eaec] pt-10 pb-10 px-10 rounded-lg'>
            ...
            <p className=" font-bold mt-2 ">
                ...
                New To  <span className='text-sky-900 sp-style text-xl'>Crystal_Palace ~ Convention Hall</span> ? <Link className='form-link' to='/signup'><span className='text-red-700'>Create an Account</span></Link>
